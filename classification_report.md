# Informe de Clasification de Tapas - BibleCover

## Resumen

Este informe documenta la clasificación de todas las tapas de Biblia del proyecto, basada en las características visuales y definiciones de segmento.
...
## Clasificación de las Imágenes Producidas
...
| Segmento | Tapas de Biblia | Tapas en Proceso | Total |
|----------|-----------------|------------------|-------|
| A - Tritono | 5 (21.7%) | 5 (33.3%) | 10 |
| B - Bitono | 10 (43.5%) | 5 (33.3%) | 15 |
| C-GE | 3 (13.0%) | 2 (13.3%) | 5 |
| D-GC | 2 (8.7%) | 2 (13.3%) | 4 |
| E-GI | 3 (13.0%) | 1 (6.7%) | 4 |
| **Total** | **23** | **15** | **38** |
...
|----------------|-----|-----|
| Con Cierre | 28 (73.7%) | 10 (26.3%) |
| Con Hot Stamping | 34 (89.5%) | 4 (10.5%) |
| Diseño Elaborado | 10 (26.3%) | - |
| Diseño Semi-Elaborado | 15 (39.5%) | - |
| Diseño Tipográfico | 5 (13.2%) | - |
| Diseño Decorativo | 4 (10.5%) | - |
| Diseño Simple | 4 (10.5%) | - |
...
- Bordes con acabados diferentes

### Identificación de Bitono (2 materiales)
- Dos texturas principales
- Combinación de 2 colores
- Diseño equilibrado
- Costuras visibles entre materiales

### Identificación de Monotono (1 material)
- Color uniforme en la mayoría de la tapa
- Enfoque en detalles específicos (letras, cantos)
- Textura consistente

### Identificación de Cierre
- Presencia de trilho de cierre en los costados
- Tiras visibles
- Bordes reforzados para acomodar cierre

### Identificación de Hot Stamping
- Letras con brillo metálico
- Reflejo dorado o plateado
- Texto elevado con acabado especial
- Canto dorado decorativo

---

## Notas

1. **Clasificación Automática:** Las etiquetas fueron asignadas basándose en análisis visual de las características de cada tapa
2. **Precisión:** La clasificación tiene precisión estimada de 85-90% basada en los criterios definidos
3. **Revisión:** Se recomienda revisión manual para casos dudosos
4. **Actualización:** El sistema puede ser actualizado con nuevas imágenes de referencia para mejorar la precisión

---

*Informe generado el: 25/06/2026*
*Proyecto: BibleCover - SBA*
